...
if (-Not (Test-Path "C:\LatestAgOpenGPS\AgOpenGPSVersionsPath.txt")) {
    ...
    $latest = dir "C:\Users\Jasper\Documents\AgOpenGPS Releases" agopengps.exe -recurse |select fullname, @{n="Version";e={[version]$_.VersionInfo.FileVersionRaw}} | sort Version | select -Last 1
